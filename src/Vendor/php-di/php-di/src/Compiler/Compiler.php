...
namespace CisionBlock\DI\Compiler;

use function chmod;
use CisionBlock\DI\Definition\ArrayDefinition;
use CisionBlock\DI\Definition\DecoratorDefinition;
use CisionBlock\DI\Definition\Definition;
use CisionBlock\DI\Definition\EnvironmentVariableDefinition;
...
use CisionBlock\DI\Definition\Reference;
use CisionBlock\DI\Definition\Source\DefinitionSource;
use CisionBlock\DI\Definition\StringDefinition;
use CisionBlock\DI\Definition\ValueDefinition;
use CisionBlock\DI\DependencyException;
use CisionBlock\DI\Proxy\ProxyFactory;
use function dirname;
use function file_put_contents;
use InvalidArgumentException;
use CisionBlock\Laravel\SerializableClosure\Support\ReflectionClosure;
use function rename;
