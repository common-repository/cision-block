...
namespace CisionBlock\DI\Proxy;

use CisionBlock\ProxyManager\Configuration;
use CisionBlock\ProxyManager\Factory\LazyLoadingValueHolderFactory;
use CisionBlock\ProxyManager\FileLocator\FileLocator;
use CisionBlock\ProxyManager\GeneratorStrategy\EvaluatingGeneratorStrategy;
use CisionBlock\ProxyManager\GeneratorStrategy\FileWriterGeneratorStrategy;
use CisionBlock\ProxyManager\Proxy\LazyLoadingInterface;
